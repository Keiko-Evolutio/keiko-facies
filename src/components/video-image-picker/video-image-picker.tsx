...
import { useMediaDevices } from '@/store/use-media-device';
import { useLocalStorage } from '@/store/use-local-storage';

import styles from '@/components/video-image-picker/video-image-picker.module.scss';
...
const VideoImagePicker = ({ show, setShow, setCurrentImage }: Props) => {
  ...
  const { storedValue: selectedDevice, setValue: setSelectedDevice } = useLocalStorage<string>(
